...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    bounds: [[31.07, 27.75], [31.25, 28.12]],
    polygonCoords: [
      [31.25, 27.75], [31.25, 28.12],
      [31.07, 28.12], [31.07, 27.75],
    ],
    ...
    landmarks: [
      ...
      { id: 'rh-9',  label: 'Direction White',                   lat: 31.084885,  lng: 28.0938281 },
      { id: 'rh-10', label: 'Fouka Bay',                         lat: 31.0848313, lng: 27.9356954 },
      { id: 'rh-11', label: 'Naia Bay',                          lat: 31.0868005, lng: 27.9254001 },
      { id: 'rh-12', label: 'Ras El Hekma Modon',               lat: 31.1182063, lng: 27.7843504 },
    ],
  },
  {
    id: 'el_dabaa',
  ...
  },
  {
    ...
    landmarks: [
      ...
      { id: 'mr-4', label: 'HDP The Island Marina 8',  lat: 30.8406349,  lng: 28.9831774  },
    ],
  },
  {
    id: 'new_alamein',
    ...
    landmarks: [
      ...
      { id: 'na-10', label: 'Latin District',            lat: 30.857,     lng: 28.905     },
      { id: 'na-11', label: 'DownTown',                  lat: 30.851,     lng: 28.917     },
      { id: 'na-12', label: 'Mazarine',                  lat: 30.849,     lng: 28.935     },
      { id: 'na-13', label: 'Mazarine Islands',          lat: 30.837,     lng: 28.947     },
      { id: 'na-14', label: 'Mazarine The Chalet',       lat: 30.844,     lng: 28.930     },
      { id: 'na-15', label: 'North Edge 4A-4B-4C',       lat: 30.869,     lng: 28.928     },
      { id: 'na-16', label: 'North Edge 7A-7B',          lat: 30.871,     lng: 28.940     },
      { id: 'na-17', label: 'The Gate',                  lat: 30.863,     lng: 28.945     },
    ],
  },
];
